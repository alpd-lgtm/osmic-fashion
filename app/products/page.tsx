...
export default function CosmicHomepageUI() {
  ...
  return (
    <div className="min-h-screen bg-[linear-gradient(180deg,#fffdfb_0%,#fff8f2_100%)] text-slate-800">
      <div className="border-b border-slate-200 bg-gradient-to-r from-blue-900 to-red-700 px-4 py-2 text-center text-[11px] text-white sm:text-sm">
      ...
      <header className="sticky top-0 z-30 border-b border-stone-200 bg-[#fcfaf7]/95 backdrop-blur">
        <div className="mx-auto flex max-w-7xl flex-wrap items-center justify-between gap-4 px-4 py-4">
          ...
          <nav className="hidden items-center gap-6 text-sm text-stone-600 md:flex">
            <a href="#categories" className="transition hover:text-blue-900">
              Collections
            </a>
            <a href="#products" className="transition hover:text-blue-900">
              Latest
            </a>
            <a href="#festive" className="transition hover:text-blue-900">
              Festive
            </a>
            <a href="#contact" className="transition hover:text-blue-900">
              Contact
            </a>
            <Link href="/products" className="transition hover:text-blue-900">
              All Products
            </Link>
          </nav>
      ...
      <main>
        <section className="mx-auto grid max-w-7xl gap-6 px-4 py-6 md:grid-cols-2 md:py-10">
          <div className="flex flex-col justify-center rounded-[28px] border border-slate-200 bg-white p-6 shadow-sm md:p-10">
            <div className="text-[11px] font-semibold uppercase tracking-[0.22em] text-red-700">
              Boutique style
            </div>

            <h1 className="mt-3 text-4xl font-semibold leading-tight text-slate-800 md:text-6xl">
              Elegant ethnic fashion
              <span className="block text-slate-400">
                with tailoring support
              </span>
            </h1>
            ...
            <div className="mt-6 flex flex-col gap-3 sm:flex-row">
              ...
              <a
                href={createWhatsAppLink(
                  "Hello, please share your latest available products."
                )}
                target="_blank"
                rel="noreferrer"
          ...
          <div className="overflow-hidden rounded-[28px] shadow-sm">
            <img
              src="https://images.unsplash.com/photo-1612336307429-8a898d10e223?auto=format&fit=crop&w=1400&q=80"
              alt="Fashion banner"
              ...
              >
                ...
                <div className="p-5">
                  ...
                  <div className="mt-4 flex flex-col gap-3 sm:flex-row">
                    <span className="inline-flex items-center justify-center rounded-full border border-slate-200 bg-white px-4 py-2.5 text-sm font-medium text-blue-900 transition group-hover:border-blue-200 group-hover:text-blue-950">
                      Browse Category
                    </span>

                    <span className="inline-flex items-center justify-center rounded-full bg-stone-100 px-4 py-2.5 text-sm font-medium text-stone-700 transition group-hover:bg-stone-200">
                      View Collection
                    </span>
                  </div>
                </div>
              ...
              >
                ...
                <div className="p-5">
                  ...
                  <div className="mt-5 flex items-center justify-between">
                    <span className="text-sm font-medium text-slate-700 transition group-hover:text-red-700">
                      View Details →
                    </span>
                    <span className="rounded-full border border-slate-200 px-3 py-1 text-xs font-medium text-slate-600 transition group-hover:border-red-200 group-hover:text-red-700">
                      Open
                    </span>
                  </div>
                </div>
          ...
          <div className="grid gap-4 rounded-[24px] border border-slate-200 bg-white p-6 shadow-sm md:grid-cols-3">
            <div>
              ...
              <p className="mt-2 text-sm text-stone-500">
                Premium boutique style with local trust, festive focus, and
                tailoring support.
              </p>
            </div>
